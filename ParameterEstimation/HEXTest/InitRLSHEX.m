...
% --- 1. Set Up Constants ---
N_MOTORS = Uav.N_ROTORS; % Or use obj.rotor_count
...
RLS_INITIAL_GUESS.force = (Uav.M \ B_force_nominal)'; % B_force_nominal is [3, n], so this is [3, n]

% RLS torque guess: Th_torque = inv(Inertia) * B_torque
