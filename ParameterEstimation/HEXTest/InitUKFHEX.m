...
jk = n_dynamics - N_MOTORS +1;
UKF.InitialState(jk+N_MOTORS: (jk-1)+7*N_MOTORS) = INITIAL_GUESS.effectiveness;
UKF.InitialState(jk+7*N_MOTORS:(jk-1)+8*N_MOTORS) = INITIAL_GUESS.motor_gain_u;
UKF.InitialState(jk+8*N_MOTORS:(jk-1)+9*N_MOTORS) = INITIAL_GUESS.motor_coeff_w;
UKF.InitialState(jk+9*N_MOTORS:(jk-1)+10*N_MOTORS) = INITIAL_GUESS.motor_coeff_w2;
